...
defaults = {'','Reverseleaning',  'M', '1'};

answer = inputdlg(prompt, 'Reverselearning', 2, defaults);  % Get experimenter's answers
...
rect = [0, 0, 580, 580];     % Make 100x100 rectangle (at the origin 0,0)taille
...
for i = iteration
  ...
  if mod(currTrial, 2)==0
      ...
      s_stimPos = 'left';
       ...
       Screen('FillRect', window, red, rectPos);
       Screen('FillOval', window, green, ovalPos);
  else
